...
function _buildSettingsTabs(deps: SettingsDeps, getPromptsConfig: () => Record<string, unknown>): { tabBtns: HTMLElement[]; panels: HTMLElement[]; tabPanels: { tabBar: HTMLElement; panelsContainer: HTMLElement } } {
